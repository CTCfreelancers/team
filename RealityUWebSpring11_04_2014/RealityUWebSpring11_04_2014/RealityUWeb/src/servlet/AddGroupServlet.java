package servlet;
/********************************************************************
 *	RealityUWeb: AddGroupServlet.java
 *	Created by Josh
 *  10/8/14
 ********************************************************************/
...
/**
 * Creates a new group but based on the coordinator code
 * added into the value on the add group page it will
 * transfer all the old data such as teacher name, high school,
 * and also the coordinator code linking all the classes that 
 * the teachers name is on.
 *
 */
...
public class AddGroupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Declare Variables
        String name, highschool, teacher, classPeriod, surveyStartDate, surveyEndDate, eventDate, studentAccessCode,marriageChoice, coordinatorCode,
        month,day,year,ssmonth,ssyear,ssday,edyear,edmonth,edday;
        ...
        //retrieves the year month and date from the Survey Start, End, and event Date
       ...
       eventDate=edmonth+("/")+edday+("/")+edyear;
        ...
        try {
        	...
        	if (request.getParameter("clear") != null || 
        		...
        		coordinatorCode = request.getParameter("coordinatorCode");
        		System.out.println(coordinatorCode);
	            ...
	            highschool = cdao.findHighschool(coordinatorCode);
	            teacher = cdao.findteacher(coordinatorCode);
      
	        	/*--========================================-->
	        	<!--Adding Marriage Choice Radio Button		-->
	        	<!--           UPDATED CODE                 -->	
	        	<!--         Created by Josh                -->
	        	<!--Also adding in the coordinator auto pass-->
	        	<!--========================================  */
	            ...
	            newGrp = new Group(0, name, null, null, highschool, teacher, classPeriod, surveyStartDate, surveyEndDate, eventDate, studentAccessCode, marriageChoice,coordinatorCode);
	            ...
	            if (lstGrpName.size() == 0 || (request.getParameter("editGroup") != null && lstGrpName.size() <= 1)) {
	            	...
	            	if (request.getParameter("editGroup") == null) {
		            	...
		            	//coordinatorCode = newGrp.generateStudentAccessCode();
		            	...
		            	gd1.insert(name, created, null, highschool, teacher, classPeriod, surveyStartDate, surveyEndDate, eventDate, studentAccessCode, marriageChoice, coordinatorCode);
		                ...
		                cdao.insert(studentAccessCode, coordinatorCode);
