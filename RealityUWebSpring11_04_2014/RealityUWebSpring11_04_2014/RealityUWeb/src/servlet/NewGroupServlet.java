...
public class NewGroupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Declare Variables
        String name, highschool, teacher, classPeriod, surveyStartDate, surveyEndDate, eventDate, studentAccessCode,marriageChoice, coordinatorCode,month,day,year,ssmonth,ssyear,ssday,edyear,edmonth,edday;
