package servlet;
/********************************************************************
 *	RealityUWeb:CoordinatorGroupServlet.java
 *	Created by Josh
 *  10/5/2014
 ********************************************************************/
 ...
 */
@WebServlet("/CoordinatorGroupServlet")
public class CoordinatorGroupServlet extends HttpServlet {
     ...
     */
    public CoordinatorGroupServlet() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
        	...
        	if (request.getParameter("clear") != null || 
        	...
        	} else if (request.getParameter("CoordinatorOpenGroup") != null) { 
	    		...
	    		if(choise .equals("yes")){
	    		   ...
	    		   coordinatorCode = cleanupString(request.getParameter("coordinatorCode")); 
	    		//end of my code   
        	...
        	if (request.getParameter("CoordinatorOpenGroup") != null) { 
        		...
        		goToPage("/CoordinatorOpenGroup.jsp", request, response);
                ...
                ses1.setAttribute("editGroupMsg", newGroupMsg); //name Msg differently
                System.out.println("Group added to Session for 'CoordinatorOpenGroup.jsp'.");
