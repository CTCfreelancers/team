	...
	public List<Survey> doProcess(List<Survey> surveysList) {
		...
		System.out.println(choice + getid);
	 	if(choice.equals("yes")){
	 		marriedRequirementRatio = .40;
			divorcedRequirementRatio = .35;
			System.out.println("Found the table with the yes as the marriage choice");
		}
	 	System.out.println(choice + getid);
	 	if(choice.equals("no")){
			marriedRequirementRatio = 0;
			divorcedRequirementRatio =0;
			System.out.println("Found the table with the no as the marriage choice");
		}
